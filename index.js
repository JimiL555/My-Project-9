...
const netflixQueue = {
    ...
    watchMovie: function () { // Changed from arrow function to regular function
        this.queue.pop();
        return "Watched a movie!";
    },
    addMovie: function (movie) { // Changed from arrow function to regular function
...
// Removed the second declaration of `doubled` and `evenNumbers`